...
public class AdapterRekapanBulananAdmin extends RecyclerView.Adapter<AdapterRekapanBulananAdmin.MyViewHolder> {

    private List<LaporanBulananModel> dalist = new ArrayList<>();
    private AdapterItemClicked adapterItemClicked;

    public AdapterRekapanBulananAdmin(AdapterItemClicked adapterItemClicked) {
        ...
        if (this.dalist == null) {
            ...
            DiffUtil.DiffResult result = DiffUtil.calculateDiff(new DiffUtil.Callback() {
                ...
                public int getOldListSize() {
                    return AdapterRekapanBulananAdmin.this.dalist.size();
                }
                ...
                public boolean areItemsTheSame(int oldItemPosition, int newItemPosition) {
                    return AdapterRekapanBulananAdmin.this.dalist.get(oldItemPosition).getIdUser() == data.get(newItemPosition).getIdUser();
                }
