...
public class AdapterRekapanHarianKaryawan extends RecyclerView.Adapter<AdapterRekapanHarianKaryawan.MyViewHolder> {

    private List<LaporanHarianModel> dalist = new ArrayList<>();
    private AdapterItemClicked adapterItemClicked;

    public AdapterRekapanHarianKaryawan(AdapterItemClicked adapterItemClicked) {
        ...
        if (this.dalist == null) {
            ...
            DiffUtil.DiffResult result = DiffUtil.calculateDiff(new DiffUtil.Callback() {
                ...
                public int getOldListSize() {
                    return AdapterRekapanHarianKaryawan.this.dalist.size();
                }
                ...
                public boolean areItemsTheSame(int oldItemPosition, int newItemPosition) {
                    return AdapterRekapanHarianKaryawan.this.dalist.get(oldItemPosition).getIdUser() == data.get(newItemPosition).getIdUser();
                }
